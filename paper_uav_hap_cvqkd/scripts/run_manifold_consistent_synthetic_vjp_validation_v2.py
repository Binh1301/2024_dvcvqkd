...
MANIFEST = ROOT / "configs/manifold_consistent_synthetic_vjp_validation_execution_manifest_v2.json"
OUTPUT = ROOT / "results/manifold_consistent_synthetic_vjp_validation_v2.json"
