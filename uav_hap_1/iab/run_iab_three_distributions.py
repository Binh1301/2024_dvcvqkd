...
if __package__ in (None, ""):
    ...
    from uav_hap_1.iab.core import simulate_three_distributions
    from uav_hap_1.protocol.qam_protocol import build_state_binomial, build_state_mb, build_state_uniform, compute_metrics
...
def main() -> None:
    ...
    from uav_hap_1.iab.core import channel as _channel  # local import keeps script entry simple
