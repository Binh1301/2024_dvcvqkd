"""
Compute Z* and key metrics for QAM-256 (uniform).
...
if __package__ in (None, ""):
    ...
    from uav_hap_1_sample.protocol.qam_protocol import build_state_uniform, compute_metrics
else:
    ...
    from .protocol.qam_protocol import build_state_uniform, compute_metrics
