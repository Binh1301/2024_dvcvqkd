"""
Compute Z* and key metrics for QAM-256 (Maxwell–Boltzmann).
...
if __package__ in (None, ""):
    ...
    from uav_hap_1_sample.protocol.qam_protocol import build_state_mb, compute_metrics
else:
...
def main() -> None:
    ...
    print("=" * 70)
    print("QAM-256 Maxwell–Boltzmann")
    print("=" * 70)
    print(f"T_eff   = {T_eff:.6f}")
    print(f"alpha0  = {state.alpha0:.6f}, Ncut = {state.ncut}, nu_tilde = {state.nu_tilde}")
    ...
    print(f"I_AB ({metrics.mi_mode}) = {metrics.i_ab:.10f}")
